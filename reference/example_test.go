...
import (
	...
	"github.com/Akagi201/swiggo/reference"
)

func TestExample(t *testing.T) {
	fmt.Println("Creating some objects:")
	a := reference.NewVector(3, 4, 5)
	b := reference.NewVector(10, 11, 12)
	...
	va := reference.NewVectorArray(10)
	fmt.Println("    va = ", va)
	...
	reference.DeleteVectorArray(va)
	reference.DeleteVector(a)
	reference.DeleteVector(b)
}
